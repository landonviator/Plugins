...
class ViatorConsoleAudioProcessorEditor  : public AudioProcessorEditor, Button::Listener, Slider::Listener
{
public:
    ViatorConsoleAudioProcessorEditor (ViatorConsoleAudioProcessor&);
    ~ViatorConsoleAudioProcessorEditor();
...
private:
    ...
    ViatorConsoleAudioProcessor& processor;
...
public:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ViatorConsoleAudioProcessorEditor)
};
