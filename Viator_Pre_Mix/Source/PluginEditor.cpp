...
//==============================================================================
ViatorConsoleAudioProcessorEditor::ViatorConsoleAudioProcessorEditor (ViatorConsoleAudioProcessor& p)
    : AudioProcessorEditor (&p), processor (p)
{
    ...
    saturateSlider->setTextBoxStyle(Slider::TextBoxBelow, false, 128, 24);
    ...
    saturateTrack->setTextBoxStyle(Slider::TextBoxBelow, false, 72, 24);
    ...
    outSlider->setTextBoxStyle(Slider::TextBoxBelow, false, 128, 24);
    ...
    outSliderTrack->setTextBoxStyle(Slider::TextBoxBelow, false, 72, 24);
...
ViatorConsoleAudioProcessorEditor::~ViatorConsoleAudioProcessorEditor()
{
}

//==============================================================================
void ViatorConsoleAudioProcessorEditor::paint (Graphics& g)
{
    g.fillAll(Colour::fromFloatRGBA(0.14f, 0.16f, 0.2f, 1.0f));
}

void ViatorConsoleAudioProcessorEditor::resized()
{
    // This is generally where you'll want to lay out the positions of any
    // subcomponents in your editor..
}

void ViatorConsoleAudioProcessorEditor::buttonClicked(Button *button)
{
...
void ViatorConsoleAudioProcessorEditor::sliderValueChanged(Slider *slider){
    ...
    if (slider == saturateTrack.get()){
        ...
        if (*processor.treeState.getRawParameterValue(AUTO_ID) == 1){
            outSliderTrack->setValue(saturateTrack->getValue() * -0.5f);
        }
    }
...
void ViatorConsoleAudioProcessorEditor::setTextColors(double color1, double color2, double color3, double alpha){
...
void ViatorConsoleAudioProcessorEditor::buttonBackgrounds(double color1, double color2, double color3, double alpha){
...
void ViatorConsoleAudioProcessorEditor::checkFineState(){
